...
//{
//    [CustomEditor(typeof(ScatterBaker))]
//    public class ScatterBakerEditor : Editor
//    {
//        ScatterBaker scatter;
...
//            scatterBuffer = new ComputeBuffer((int)scatter.maxInstance, sizeof(float) * 4, ComputeBufferType.Append);
